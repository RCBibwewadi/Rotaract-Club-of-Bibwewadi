...
const defaultContent: SiteContent = {
  ...
  boardMembers: [
    { id: '1', name: 'Rtr. Aarav Sharma', role: 'President', bio: 'Passionate about community development and youth empowerment.', gradient: 'from-[#8b1a2b] to-[#a82640]' },
    { id: '2', name: 'Rtr. Priya Deshmukh', role: 'Vice President', bio: 'Driving innovation in social service through technology.', gradient: 'from-[#a82640] to-[#c9a84c]' },
    { id: '3', name: 'Rtr. Rohan Kulkarni', role: 'Secretary', bio: 'Ensuring smooth operations and effective communication.', gradient: 'from-[#c9a84c] to-[#8b1a2b]' },
    { id: '4', name: 'Rtr. Sneha Patil', role: 'Treasurer', bio: 'Managing finances with transparency and accountability.', gradient: 'from-[#8b1a2b] to-[#c9a84c]' },
    { id: '5', name: 'Rtr. Vikram Joshi', role: 'Director - Service', bio: 'Leading impactful service projects across the community.', gradient: 'from-[#a82640] to-[#8b1a2b]' },
    { id: '6', name: 'Rtr. Ananya Mehta', role: 'Director - Club Service', bio: 'Building fellowship and strengthening internal bonds.', gradient: 'from-[#c9a84c] to-[#a82640]' },
  ],
  projects: [
    { id: '1', title: 'Clean Bibwewadi Drive', category: 'Environment', description: 'Community-wide cleanliness campaign engaging 200+ volunteers.', gradient: 'from-[#8b1a2b] to-[#a82640]', date: '2025-03-15' },
    { id: '2', title: 'Blood Donation Camp', category: 'Health', description: 'Annual blood donation drive collecting 150+ units.', gradient: 'from-[#a82640] to-[#c9a84c]', date: '2025-02-20' },
    { id: '3', title: 'Digital Literacy Workshop', category: 'Education', description: 'Teaching basic computer skills to underprivileged youth.', gradient: 'from-[#c9a84c] to-[#8b1a2b]', date: '2025-04-10' },
    { id: '4', title: 'Tree Plantation Drive', category: 'Environment', description: 'Planted 500+ saplings across Bibwewadi locality.', gradient: 'from-[#8b1a2b] to-[#c9a84c]', date: '2025-01-25' },
    { id: '5', title: 'Career Guidance Seminar', category: 'Education', description: 'Guiding students on career paths and opportunities.', gradient: 'from-[#a82640] to-[#8b1a2b]', date: '2025-05-05' },
    { id: '6', title: 'Food Distribution Drive', category: 'Community', description: 'Distributing meals to 300+ families in need.', gradient: 'from-[#c9a84c] to-[#a82640]', date: '2025-06-01' },
  ],
  events: [
