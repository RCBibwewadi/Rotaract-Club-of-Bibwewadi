 ...
 * A friendly, round-faced character with a burgundy beret and Rotary-inspired badge.
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="#8b1a2b"
      />
      <ellipse cx="100" cy="82" rx="46" ry="8" fill="#8b1a2b" />
      {/* Beret nub */}
      <circle cx="100" cy="46" r="6" fill="#c9a84c" />
      ...
      />
      {/* Badge – Rotary gear */}
      <circle cx="100" cy="176" r="9" fill="#8b1a2b" />
      <circle cx="100" cy="176" r="5" fill="#c9a84c" />
